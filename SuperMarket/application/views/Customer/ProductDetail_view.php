        ...
        <div class="row s_product_inner">
          ...
          <div class="col-lg-6">
            <div class="s_product_img">
              <img style="width: 600px;height: 400px"  src="<?= base_url() ?><?= $value['img'] ?>">
            </div>
          </div>
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              <h3><?= $value['name'] ?></h3>
              <h4><span class="mr-4">$<?= $value['price'] ?></span>
                <del>$<?= $value['discount'] ?></del></h4>
              <ul class="list">
                <li>
                  <a class="active" href="#">
                    <span>Category</span>
                     <?php foreach ($get_catalog as $danhmuc): ?>
              
                     	<?php if($value['catalog_id']==$danhmuc['child_id']){?>
                     	<?= $danhmuc['name_child'] ?>
                     	<?php }else{ ?>
              ...
              <div class="card_area">
                <a class="main_btn" href="<?= base_url() ?>Customer/Cart/add/<?= $value['id'] ?>">Add to Cart</a>
