...
<head>
  ...
  <link href="<?= base_url()?>A/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>Admin/Admin/Product">
          <i class="fas fa-fw fa-table"></i>
          <span>Danh sách sản phẩm</span></a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>Admin/Catalog">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Xin Chào <?= $this->session->userdata('username'); ?></span>
